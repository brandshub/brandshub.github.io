...
(function(){
  (function($){
    ...
    (function(){
      ...
      $link_hover = $('<a class="dropdown-item bg-dark text-light">123</a>').hover(); //$('<button class="btn btn-link  text-white" />').hover();
